...
// Forked by erwan@prismic.io to expose some fields that I need for my backport
 ...
 * @see HttpServerCodec
 */
public final class HttpClientCodec2
   ...
   */
  public HttpClientCodec2(int maxInitialLineLength, int maxHeaderSize, int maxChunkSize) {
